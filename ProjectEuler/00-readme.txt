...
Then I realized that these problems had to be solved with computer programs or algorithms
Had me worried there for a second!

Project Euler insists on not sharing the source code
so not to spoil the experience for others and to follow the rules. 
I am going to solve the problems in a compiled program so not to spoil it for others!

you can download the compiled programs, and run them from the terminal
eg:
$ cd projectEuler
$ ./01-Multiples-of-3-and-5
they will prompt you for input!
